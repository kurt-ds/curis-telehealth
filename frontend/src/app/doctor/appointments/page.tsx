...
const APPOINTMENTS: Appointment[] = [
  { id: 'apt-001', patientName: 'Robert Miller',   patientId: 'RM-4492-00', initials: 'RM', avatarColor: '#4a9d8f', type: 'Tele-consult',   date: '2026-05-27', time: '09:00 AM', status: 'upcoming' },
  { id: 'apt-002', patientName: 'Elena Rodriguez', patientId: 'ER-3310-01', initials: 'ER', avatarColor: '#5b8dd9', type: 'Follow-up',       date: '2026-05-27', time: '10:00 AM', status: 'upcoming' },
  { id: 'apt-003', patientName: 'Samuel Chen',     patientId: 'SC-7721-02', initials: 'SC', avatarColor: '#c0784b', type: 'Routine Check',   date: '2026-05-27', time: '11:30 AM', status: 'upcoming' },
  { id: 'apt-004', patientName: 'Miriam Thompson', patientId: 'MT-5509-03', initials: 'MT', avatarColor: '#9b9b9b', type: 'Prescription',    date: '2026-05-26', time: '02:00 PM', status: 'completed', notes: 'Renewed metformin prescription.' },
  { id: 'apt-005', patientName: 'Marcus Vane',     patientId: 'MV-1134-04', initials: 'MV', avatarColor: '#7c5cbf', type: 'Initial Consult', date: '2026-05-26', time: '04:00 PM', status: 'completed', notes: 'Discussed diet plan and lab results.' },
  { id: 'apt-006', patientName: 'Aisha Ramos',     patientId: 'AR-2200-05', initials: 'AR', avatarColor: '#d9715b', type: 'Follow-up',       date: '2026-05-25', time: '09:30 AM', status: 'cancelled' },
];
...
export default function DoctorAppointments() {
  ...
  const confirmCancel = async () => {
    ...
    // TODO: PATCH /api/doctor/appointments/:id/status { status: 'cancelled', notes: cancelReason }
            ...
            return (
              <div key={apt.id} className="bg-white border border-slate-100 rounded-2xl shadow-sm px-5 py-4 flex flex-col sm:flex-row sm:items-center gap-4 hover:shadow-md transition-shadow duration-200">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-slate-500">{apt.type} &bull; {fmtDate(apt.date)} at {apt.time}</p>
